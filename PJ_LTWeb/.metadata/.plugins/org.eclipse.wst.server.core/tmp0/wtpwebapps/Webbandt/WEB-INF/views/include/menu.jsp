...
<link href="<c:url value='resources/assets/list/list.css'/>" rel="stylesheet">
<div class="container-wrapper fixed-top navbar-dark btn-primary bg-gradient ">
...
<div class="container-wrapper navbar-wrapper navbar-expand-lg ">
	...
	<div class="row">
		<div class="col">
			<a class="navbar-brand mb-0 sizemenu" href="#"><i class="fas fa-phone"></i> 0366446373</a>
			<a class="navbar-brand mb-0 sizemenu" href="#"><i class="far fa-paper-plane"></i> DTT@gmail.com</a>
		</div>
...
<div class="navbar-home navbar-expand-lg container-wrapper ">
	...
	<div class="row">
	    <div class="col">
	     	<a class="navbar-brand mb-0 h1" href="#"><i class="fas fa-shopping-bag"></i> Điện thoại DTT</a>
	    </div>
	    <div class="col-8 ">
	...
	<form class="d-none d-sm-inline-block form-inline mr-auto my-2 my-lg-0 " style="width: 700px;" action="home/search.htm">
       <div class="input-group ">
         ...
         <button class="btn btn-outline-danger my-2 my-sm-0" type="submit"> <i class="fas fa-search fa-sm"></i></button>
         </div>
       </div>
    </form>
