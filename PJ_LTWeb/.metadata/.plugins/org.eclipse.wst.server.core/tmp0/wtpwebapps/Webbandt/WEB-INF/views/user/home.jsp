					...
					<div class="card h-100">
						...
						<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
							<div class="text-center">
								...
								<a class="btn btn-outline-primary mt-auto" href="home/product.htm?id=${s.id}">Xem chi tiết</a>
								<c:choose>
									<c:when test="${s.quantity > s.sold_quantity }">
										<a class="btn btn-outline-primary mt-auto" href="user/addCart.htm?id=${s.id }"><i class="fas fa-cart-plus fs-4"></i></a>
									</c:when>
									<c:otherwise>
